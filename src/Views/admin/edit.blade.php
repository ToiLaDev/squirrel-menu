            ...
            <form method="post" action="{{route('admin.menus.update', $menu->id)}}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <x-forms.input name="title" :value="$menu->title" />
                            </div>
                            <div class="col-12">
                                <x-forms.input name="url" :value="$menu->url" />
                            </div>
                            <div class="col-12">
                                <x-forms.select name="target" :options="['_blank','_self','_parent','_top']" default="_____" :value="$menu->target" />
                            </div>
                            <div class="col-12">
                                <x-forms.select name="parent_id" title="Parent" :value="$menu->parent_id" :options="$options" default="_____" />
                            </div>
